#   Mohamed BEN ALI  Deep Learning - Big DATA   #
### *************************************************** ###
...
train_data_dir = '/home/mohamed/Desktop/cnn_keras_iTeam/train'
validation_data_dir = '/home/mohamed/Desktop/cnn_keras_iTeam/validation'
test_data_dir = '/home/mohamed/Desktop/cnn_keras_iTeam/test'
...
if not os.path.exists('dog-cat-final-model.h5'):
    ...
    plot_model(model, to_file='cat-dog.png', show_shapes=True)
...
image = image.load_img('/home/mohamed/Desktop/cnn_keras_iTeam/test/dog/2001.jpg',target_size=(150,150,3))
